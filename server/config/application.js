...
module.exports = app => {
  ...
  app.set("PG_USER", process.env.PG_USER || "kanikasmacbook");
  app.set("PG_PASSWORD", process.env.PG_PASSWORD || "boomtown");
  app.set("PG_DB", process.env.G_DB || "boomtown");
  app.set("JWT_SECRET", process.env.JWT_SECRET || "Kanika");
  app.set("JWT_COOKIE_NAME", process.env.JWT_COOKIE_NAME || "cookieelsa");
